...
describe('GetProductUseCase', () => {
    ...
    describe('execute()', () => {
        it('should return product when found', async () => {
            const product = Product_1.Product.fromPersistence(mockProductData);
        ...
        it('should return error for inactive product', async () => {
            const inactiveProduct = Product_1.Product.fromPersistence({
                ...mockProductData,
                isActive: false,
            });
        ...
        it('should handle repository errors', async () => {
            ...
            await expect(useCase.execute({ id: 'prod123' })).rejects.toThrow('Database connection failed');
        });
    });
});
//# sourceMappingURL=GetProductUseCase.test.js.map